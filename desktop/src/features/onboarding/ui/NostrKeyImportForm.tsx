    ...
    >
      {!isPasswordStage && (
        <div className="mb-2 flex flex-col items-center gap-2">
          <Button
            className="flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-border bg-card px-6 font-medium text-foreground shadow-sm transition-all hover:bg-accent hover:text-accent-foreground"
            data-testid="google-workspace-signin-button"
            disabled={isInteractionDisabled || isGoogleSigningIn}
          ...
          <p className="text-xs text-muted-foreground">
            Restricted to company accounts ending with @k2alpha.ai
          </p>
