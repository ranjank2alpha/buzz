...
export type MentionSuggestion = {
  ...
  /** For a `"scope"` suggestion: the global-mention scope it inserts. */
  scope?: "channel" | "here";
  /** For a `"scope"` suggestion: the one-line explanation shown beneath it. */
  description?: string;
  displayName: string;
